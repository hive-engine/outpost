...
export const TOKEN = 'BRK'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://icebrk.io'
export const APP_TITLE = 'IceBreak'
export const APP = `icebreak/${version}`
...
export const NUMBER_OF_UNSTAKE_TRX = 30

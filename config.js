...
export const TOKEN = 'ZARK'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://retzark.com'
export const APP_TITLE = 'Retzark'
export const APP = `retzark/${version}`

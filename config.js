...
export const COMMUNITY_CATEGORY = 'hive-150840'
export const AUTO_ADD_COMMUNITY = true
export const SCOT_TAG = 'hivelist'
...
export const NFT_SYMBOL = 'LISTNFT'
export const NFT_MARKETPLACE = 'hivelist'
...
export const OUTPOST_ONBOARD_ID = 'hivelist'
export const HCAPTCHA_KEY = '122546c1-1315-4646-9ca0-a0834d0b8904'

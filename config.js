...
export const TOKEN = 'SCP'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://www.paranormalhive.org'
export const APP_TITLE = 'Paranormal Hive'
export const APP = `paranormalhive/${version}`
...
export const COMMUNITY_CATEGORY = 'hive-117752'
export const AUTO_ADD_COMMUNITY = true
export const SCOT_TAG = 'paranormalhive'
...
export const NUMBER_OF_UNSTAKE_TRX = 15

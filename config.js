...
export const TOKEN = 'BEVR'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://post.beaver.social'
export const APP_TITLE = 'Beaver.Social'
export const APP = `beaver/${version}`
...
export const COMMUNITY_CATEGORY = 'hive-168543'
export const AUTO_ADD_COMMUNITY = true
export const SCOT_TAG = 'bevr'

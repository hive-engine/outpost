...
export const TOKEN = 'THIA'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://www.thiagore.com'
export const APP_TITLE = 'ThiagoRe.com'
export const APP = `thiagorewards/${version}`
...
export const COMMUNITY_CATEGORY = 'hive-153750'
export const AUTO_ADD_COMMUNITY = false
export const SCOT_TAG = 'thiagore'
...
export const NUMBER_OF_UNSTAKE_TRX = 21
...
export const NFT_SYMBOL = 'THIA'
export const NFT_MARKETPLACE = 'thiagore'

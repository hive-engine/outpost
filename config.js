...
export const TOKEN = 'SPORTS'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://www.sportstalksocial.com'
export const APP_TITLE = 'SportsTalkSocial'
export const APP = `sportstalksocial/${version}`
...
export const SCOT_TAG = 'hive-101690'
...
export const OUTPOST_ONBOARD_ID = 'sportstalksocial'
export const HCAPTCHA_KEY = '2a9bbe40-342a-4890-a04e-33291ce95ba6'

...
export const TOKEN = 'BZT'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://blazarforce.com'
export const APP_TITLE = 'Blazar Force'
export const APP = `blazarforce/${version}`
...
export const SCOT_TAG = 'blazarforce'

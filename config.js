...
export const TOKEN = 'VOTE'
export const IS_HIVE = true
export const APP_DOMAIN = 'https://www.politicalhive.org'
export const APP_TITLE = 'Political Hive'
export const APP = `politicalhive/${version}`
...
export const COMMUNITY_CATEGORY = 'hive-120417'
export const AUTO_ADD_COMMUNITY = true
export const SCOT_TAG = 'politicalhive'
